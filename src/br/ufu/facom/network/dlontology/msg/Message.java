...
public class Message {
	...
	public Message(String source, String destination, int  vlan, byte[] payload, boolean fragmented, String sequence, String label){
		this.label = label;
		this.source = source;
	...
	public Message(String source, String destination,int vlan, byte[] payload, String label) {
